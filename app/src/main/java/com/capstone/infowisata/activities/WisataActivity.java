...
public class WisataActivity extends AppCompatActivity implements WisataAdapter.onSelectData {
    ...
    Toolbar tbWisata;
    private JSONArray AndroidNetworking;
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(com.capstone.infowisata.activities.WisataActivity.this,
    ...
    private void showWisata() {
        kulinerAdapter = new WisataAdapter(com.capstone.infowisata.activities.WisataActivity.this, modelKuliner, this);
        rvWisata.setAdapter(kulinerAdapter);
    }

    @Override
    public void onSelected(ModelWisata modelWisata) {
        Intent intent = new Intent(com.capstone.infowisata.activities.WisataActivity.this, DetailWisataActivity.class);
