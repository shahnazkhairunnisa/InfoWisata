...
import com.capstone.infowisata.adapter.MainAdapter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    public void onSelected(ModelMain mdlMain) {
        switch (mdlMain.getTxtName()) {
            ...
            case "Wisata":
                startActivityForResult(new Intent(com.capstone.infowisata.activities.MainActivity.this, WisataActivity.class), 1);
                break;
        }
    }
